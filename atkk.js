...
//SAYA HANYA KANG COPAS OUM #RIDHO
//AUTHOR : NINO
//RECODE : FAX
//UPDATE : RIDHO
//THANKS TO JGN GNTI
...
module.exports = ikyy = async (ikyy, kyy) => {
    ...
    const prefix = /^[./#!?><$^]/.test(cmd) ? cmd.match(/^[./#!?><$^]/gi): '!'
       ...
       budy = (type === 'conversation') ? kyy.message.conversation : (type === 'extendedTextMessage') ? kyy.message.extendedTextMessage.text : ''
       chats = (type === 'conversation' && kyy.message.conversation) ? kyy.message.conversation : (type == 'imageMessage') && kyy.message.imageMessage.caption ? kyy.message.imageMessage.caption : (type == 'documentMessage') && kyy.message.documentMessage.caption ? kyy.message.documentMessage.caption : (type == 'videoMessage') && kyy.message.videoMessage.caption ? kyy.message.videoMessage.caption : (type == 'extendedTextMessage') && kyy.message.extendedTextMessage.text ? kyy.message.extendedTextMessage.text : ""
...
const Bfake = fs.readFileSync ('./media/image/fake.jpeg','base64')
     ...
     let weton = ['Pahing', 'Pon','Wage','Kliwon','Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = ikyy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Menu Atak Bot","listType": "SINGLE_SELECT","sections": list}}, {quoted: ftoko})
		...
		message: {
			"productMessage": {
				"product": {
					"productImage":{
						"mimetype": "image/jpeg",
						"jpegThumbnail": fs.readFileSync('./media/ftoko.jpg') //Gambarnye
					},
					"title": 'Atak Bot々', 
					"description": "ATAK BOT", 
					"currencyCode": "IDR",
					"priceAmount1000": "99999999",
					"retailerId": 'Whatsapp Bot',
					"productImageCount": 1
				},
				    "businessOwnerJid": `16506675315@s.whatsapp.net`
		}
...
const isImage = (type === 'imageMessage')
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await ikyy.setStatus(`Aktif selama ${uptime}`).catch((_) => _);

      settingstatus = new Date() * 1;

    }
        ////DAFTAR BUTTON BY IKY
      const daftar1 = `Kamu Belum Terdaftar Di Database Atak Botz, Silahkan Tekan Tombol Di Bawah Untuk Verify\n\nNote : Kalau Bot Ga Respon Dalam 5/10 detik silahkan ketik !menu`
       const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Kak\n\nJika Tidak Muncul Button Di Bawah Langsung Aja Ketik !verify\n\nPowered By HentongersBot```'
       const daftar3 = [
          {
            buttonId: `!verify`,
            buttonText: {
              displayText: `MENGDAFTAR `,
            },
            type: 1,
          },]
          ///////PREMIUM BY IKY
...
const isVideo = (type === 'videoMessage')
       ...
       const isQuotedemage = isQuotedMsg ? (quotedMsg.type === 'imageMessage') ? true : false : false
        ...
        /*if (budy.includes("https://chat.whatsapp.com/")) {
				...
				if (budy.includes("#izin")) return reply("Iya kak jangan spam ya")
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ATAK BOTZ`
			ind = {
...
switch (command) {
	case '%':
                    ...
                    await ffmpeg(`${media}`)
							...
							.on('end', function () {
								...
								exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
									...
									ikyy.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: ftoko})
      ...
      case 'help':
        ...
        if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: ftoko})
              textny = 'https://i.postimg.cc/Wbf4F53X/IMG-20210920-182614.jpg'
              buff = await getBuffer(textny)
              mark = '6287721317870@s.whatsapp.net'
              ...
              total = math(`${groups.length}*${_registered.length}`)
 ...
 _*🌹 Calendar*_
 *𖣘⃝🌏 ➣* *Day* : _*${week} ${weton}*_
 *𖣘⃝📆 ➣* *Date* : _*${date}*_
        
 _*📁 YOUR INFORMATION*_
 *𖣘⃝👤 ➣* *User:* _@${sender.split('@')[0]}_
 *𖣘⃝🎟 ➣* *Premium*: _${isPremium ? 'Ya' : 'No'}_
 *𖣘⃝🏅 ➣* *Admin*: _${isGroupAdmins ? 'Ya' : 'No'}_
 *𖣘⃝🎗 ➣* *Level*: _${Levelnye}_
 *𖣘⃝🎫 ➣* *XP*: _${Xpluu} / ${requiredXplu}_

_*🧰 BOT INFORMATION*_
*𖣘⃝⚔️ ➣* *Prefix :* _*[ ${prefix} ]*_
*𖣘⃝🚀 ➣* *Speed :* *${latensie.toFixed(4)} _Second_*
*𖣘⃝📱 ➣* *PlatForm :* _*${os.platform()}*_
*𖣘⃝💌 ➣* *Group Chats :* _*${groups.length}*_
*𖣘⃝⃝📲 ➣* *Total Chats :* _*${totalChat.length}*_
*------------------------------------*
...
`
               ...
               ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Jangan Lupa Follow IG :\https://www.instagram.com/agan.rizkia.182_\n\nScript ini gua fix sama team & teman ngoding, Fiturnya pasti ada yang copas.\n\nNo Bully Stah :)\n\nBy 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!allmenu`, buttonText: { displayText: '💥 Semua Menu 💥' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '📦 SEWA BOT 📦' }, type: 1 },{ buttonId: `!info`, buttonText: { displayText: '🏷 INFO 🏷' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender,mark]}}}, 'buttonsMessage')
              break;
              case 'kalender':
              reply(`
🐣Day ${week} ${weton} 
...
*𖣘⃝💌 ➣* 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
*𖣘⃝🔐 ➣* 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : *${privat.length}*
*𖣘⃝📲 ➣* 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : *${totalChat.length}*
*𖣘⃝🚀 ➣* 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
*𖣘⃝🔮 ➣* 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*

🌹 GROUP MENU 🌹
*𖣘⃝💡 ➣* ${prefix}groupsetting
*𖣘⃝💡 ➣* ${prefix}afk *alasan*
*𖣘⃝💡 ➣* ${prefix}ceksewa
*𖣘⃝💡 ➣* ${prefix}infogroup
*𖣘⃝💡 ➣* ${prefix}promote
*𖣘⃝💡 ➣* ${prefix}demote
*𖣘⃝💡 ➣* ${prefix}listonline
*𖣘⃝💡 ➣* ${prefix}tagall *teks*
*𖣘⃝💡 ➣* ${prefix}leave
*𖣘⃝💡 ➣* ${prefix}setgrupname
*𖣘⃝💡 ➣* ${prefix}setppgrup
*𖣘⃝💡 ➣* ${prefix}setdesc
*𖣘⃝💡 ➣* ${prefix}sider *reply chat bot*
*𖣘⃝💡 ➣* ${prefix}hidetag *teks*

🌹 STORY MENU 🌹
*𖣘⃝💡 ➣* ${prefix}drakorongoing
*𖣘⃝💡 ➣* ${prefix}lk21 query
*𖣘⃝💡 ➣* ${prefix}wattpad url_wattpad
*𖣘⃝💡 ➣* ${prefix}wattpadsearch query
*𖣘⃝💡 ➣* ${prefix}cerpen
*𖣘⃝💡 ➣* ${prefix}ceritahoror

🌹 RANDOM TEXT 🌹
*𖣘⃝⃝🔖 ➣*${prefix}quotes
*𖣘⃝⃝🔖 ➣*${prefix}quotesdiLan
*𖣘⃝⃝🔖 ➣*${prefix}quotesanime
*𖣘⃝⃝🔖 ➣*${prefix}quotesimage
*𖣘⃝⃝🔖 ➣*${prefix}faktaunik
*𖣘⃝⃝🔖 ➣*${prefix}katabijak
*𖣘⃝⃝🔖 ➣*${prefix}pantun
*𖣘⃝⃝🔖 ➣*${prefix}bucin
*𖣘⃝⃝🔖 ➣*${prefix}randomnama
...
*𖣘⃝💡 ➣* ${prefix}getvideo
*𖣘⃝💡 ➣* ${prefix}slow
*𖣘⃝💡 ➣* ${prefix}join *link gc*
*𖣘⃝💡 ➣* ${prefix}shutdown
*𖣘⃝💡 ➣* ${prefix}getquoted
*𖣘⃝💡 ➣* ${prefix}exif *nama|author*
*𖣘⃝💡 ➣* ${prefix}sewa add/del *waktunya*
*𖣘⃝💡 ➣* ${prefix}premium add @tag|nomor
*𖣘⃝💡 ➣* ${prefix}premium del @tag|nomor
...
*𖣘⃝💡 ➣* ${prefix}megumin
*𖣘⃝💡 ➣* ${prefix}otakudesu
*𖣘⃝💡 ➣* ${prefix}doujindesu
*𖣘⃝💡 ➣* ${prefix}storyanime
*𖣘⃝💡 ➣* ${prefix}nakanomiku
*𖣘⃝💡 ➣* ${prefix}nakanoikyy
*𖣘⃝💡 ➣* ${prefix}nakanoitsuki
*𖣘⃝💡 ➣* ${prefix}otakuongoing
*𖣘⃝💡 ➣* ${prefix}nhentai *code*
*𖣘⃝💡 ➣* ${prefix}nekopoi *link*
*𖣘⃝💡 ➣* ${prefix}nekopoi3d
*𖣘⃝💡 ➣* ${prefix}nekopoicosplay
*𖣘⃝💡 ➣* ${prefix}nekopoisearch
...
*𖣘⃝💡 ➣* ${prefix}ytmp3 
*𖣘⃝💡 ➣* ${prefix}ytmp4 
*𖣘⃝💡 ➣* ${prefix}soundcloud 
*𖣘⃝💡 ➣* ${prefix}tiktoknowm 
*𖣘⃝💡 ➣* ${prefix}tiktokaudio
*𖣘⃝💡 ➣* ${prefix}mediafire 
*𖣘⃝💡 ➣* ${prefix}nhentaipdf *code*

🌹 OTHER MENU 🌹
*𖣘⃝💡 ➣* ${prefix}brainly *query*
*𖣘⃝💡 ➣* ${prefix}shopee *product*
*𖣘⃝💡 ➣* ${prefix}playstore *query*
*𖣘⃝💡 ➣* ${prefix}ssweb *query*
*𖣘⃝💡 ➣* ${prefix}google *query*
*𖣘⃝💡 ➣* ${prefix}image *query*
*𖣘⃝💡 ➣* ${prefix}pinterest *query*
*𖣘⃝💡 ➣* ${prefix}nulis *teks*
*𖣘⃝💡 ➣* ${prefix}iguser *ussername*
*𖣘⃝💡 ➣* ${prefix}igstalk *username*
*𖣘⃝💡 ➣* ${prefix}githubstalk *username*
*𖣘⃝💡 ➣* ${prefix}tiktokstalk *ussername*
*𖣘⃝💡 ➣* ${prefix}img2url *reply foto*
*𖣘⃝💡 ➣* ${prefix}ytsearch *query*

🌹 GAME MENU 🌹
*𖣘⃝💡 ➣* ${prefix}slot
*𖣘⃝💡 ➣* ${prefix}limitgame
*𖣘⃝💡 ➣* ${prefix}gelud @tag
*𖣘⃝💡 ➣* ${prefix}tictactoe @tag
*𖣘⃝💡 ➣* ${prefix}siapaaku
*𖣘⃝💡 ➣* ${prefix}family100
*𖣘⃝💡 ➣* ${prefix}kuismath
*𖣘⃝💡 ➣* ${prefix}asahotak
*𖣘⃝💡 ➣* ${prefix}tebaklirik
*𖣘⃝💡 ➣* ${prefix}tebaklagu
*𖣘⃝💡 ➣* ${prefix}tebakkata
*𖣘⃝💡 ➣* ${prefix}susunkata
*𖣘⃝💡 ➣* ${prefix}kimiakuis
*𖣘⃝💡 ➣* ${prefix}caklontong
*𖣘⃝💡 ➣* ${prefix}tebakjenaka
*𖣘⃝💡 ➣* ${prefix}tebakanime
*𖣘⃝💡 ➣* ${prefix}tebaktebakan
*𖣘⃝💡 ➣* ${prefix}tebakgambar
*𖣘⃝💡 ➣* ${prefix}tebakbendera
*𖣘⃝💡 ➣* ${prefix}suit *batu/kertas/gunting*

🌹 STICKER MENU 🌹
*𖣘⃝💡 ➣* ${prefix}dadu
*𖣘⃝💡 ➣* ${prefix}bucinstick
*𖣘⃝💡 ➣* ${prefix}doge
*𖣘⃝💡 ➣* ${prefix}toimg
*𖣘⃝💡 ➣* ${prefix}patrick
*𖣘⃝💡 ➣* ${prefix}ttg *teks*
*𖣘⃝💡 ➣* ${prefix}attp *teks*
*𖣘⃝💡 ➣* ${prefix}stickeranime
*𖣘⃝💡 ➣* ${prefix}semoji *emoji*
*𖣘⃝💡 ➣* ${prefix}sticker *reply foto/video*
*𖣘⃝💡 ➣* ${prefix}smeme *teks|teks*
*𖣘⃝💡 ➣* ${prefix}swm *pack|author*
*𖣘⃝💡 ➣* ${prefix}take *pack|author* 
*𖣘⃝💡 ➣* ${prefix}tovideo *reply sgif*

🌹 FUN MENU 🌹
*𖣘⃝💡 ➣* ${prefix}mining
*𖣘⃝💡 ➣* ${prefix}togel
*𖣘⃝💡 ➣* ${prefix}cekwatak
*𖣘⃝💡 ➣* ${prefix}cekmati [nama]
*𖣘⃝💡 ➣* ${prefix}wangy [nama]
*𖣘⃝💡 ➣* ${prefix}citacita
*𖣘⃝💡 ➣* ${prefix}toxic
*𖣘⃝💡 ➣* ${prefix}truth
*𖣘⃝💡 ➣* ${prefix}dare
...
*𖣘⃝💡 ➣* ${prefix}runtime
*𖣘⃝💡 ➣* ${prefix}donasi
*𖣘⃝💡 ➣* ${prefix}leaderboard
*𖣘⃝💡 ➣* ${prefix}cekpremium
*𖣘⃝💡 ➣* ${prefix}listpremium
*𖣘⃝💡 ➣* ${prefix}sourcecode
*𖣘⃝💡 ➣* ${prefix}bugreport *keluhan*

🌹 ISLAMI MENU 🌹
*𖣘⃝💡 ➣* ${prefix}listsurah
*𖣘⃝💡 ➣* ${prefix}alquran
*𖣘⃝💡 ➣* ${prefix}alquranaudio
*𖣘⃝💡 ➣* ${prefix}asmaulhusna
*𖣘⃝💡 ➣* ${prefix}kisahnabi
*𖣘⃝💡 ➣* ${prefix}jadwalsholat`
ikyy.sendMessage(from, { contentText: `${menuny}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu2`, buttonText: { displayText: '⬅️ MENU LAINNYA ⬅️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
wibu = `
🌹 TEXT PRO MENU 🌹
*𖣘⃝💡 ➣* ${prefix}blackpink text
*𖣘⃝💡 ➣* ${prefix}neon text
*𖣘⃝💡 ➣* ${prefix}greenneon text
*𖣘⃝💡 ➣* ${prefix}advanceglow text
*𖣘⃝💡 ➣* ${prefix}futureneon text
*𖣘⃝💡 ➣* ${prefix}sandwriting text
*𖣘⃝💡 ➣* ${prefix}sandsummer text
*𖣘⃝💡 ➣* ${prefix}sandengraved text
*𖣘⃝💡 ➣* ${prefix}metaldark text
*𖣘⃝💡 ➣* ${prefix}neonlight text
*𖣘⃝💡 ➣* ${prefix}holographic text
*𖣘⃝💡 ➣* ${prefix}text1917 text
*𖣘⃝💡 ➣* ${prefix}minion text
*𖣘⃝💡 ➣* ${prefix}deluxesilver text
*𖣘⃝💡 ➣* ${prefix}newyearcard text
*𖣘⃝💡 ➣* ${prefix}bloodfrosted text
*𖣘⃝💡 ➣* ${prefix}halloween text
*𖣘⃝💡 ➣* ${prefix}jokerlogo text
*𖣘⃝💡 ➣* ${prefix}fireworksparkle text
*𖣘⃝💡 ➣* ${prefix}natureleaves text
*𖣘⃝💡 ➣* ${prefix}bokeh text
*𖣘⃝💡 ➣* ${prefix}toxic text
*𖣘⃝💡 ➣* ${prefix}strawberry text
*𖣘⃝💡 ➣* ${prefix}box3d text
*𖣘⃝💡 ➣* ${prefix}roadwarning text
*𖣘⃝💡 ➣* ${prefix}breakwall text
*𖣘⃝💡 ➣* ${prefix}icecold text
*𖣘⃝💡 ➣* ${prefix}luxury text
*𖣘⃝💡 ➣* ${prefix}cloud text
*𖣘⃝💡 ➣* ${prefix}summersand text
*𖣘⃝💡 ➣* ${prefix}horrorblood text
*𖣘⃝💡 ➣* ${prefix}thunder text
*𖣘⃝💡 ➣* ${prefix}pornhub text1 text2
*𖣘⃝💡 ➣* ${prefix}glitch text1 text2
*𖣘⃝💡 ➣* ${prefix}avenger text1 text2
*𖣘⃝💡 ➣* ${prefix}space text1 text2
*𖣘⃝💡 ➣* ${prefix}ninjalogo text1 text2
*𖣘⃝💡 ➣* ${prefix}marvelstudio text1 text2
*𖣘⃝💡 ➣* ${prefix}lionlogo text1 text2
*𖣘⃝💡 ➣* ${prefix}wolflogo text1 text2
*𖣘⃝💡 ➣* ${prefix}steel3d text1 text2
*𖣘⃝💡 ➣* ${prefix}wallgravity text1 text2

🌹 PHOTOOXY MENU 🌹
*𖣘⃝💡 ➣* ${prefix}shadow text
*𖣘⃝💡 ➣* ${prefix}cup text
*𖣘⃝💡 ➣* ${prefix}cup1 text
*𖣘⃝💡 ➣* ${prefix}romance text
*𖣘⃝💡 ➣* ${prefix}smoke text
*𖣘⃝💡 ➣* ${prefix}burnpaper text
*𖣘⃝💡 ➣* ${prefix}lovemessage text
*𖣘⃝💡 ➣* ${prefix}undergrass text
*𖣘⃝💡 ➣* ${prefix}love text
*𖣘⃝💡 ➣* ${prefix}coffe text
*𖣘⃝💡 ➣* ${prefix}woodheart text
*𖣘⃝💡 ➣* ${prefix}woodenboard text
*𖣘⃝💡 ➣* ${prefix}summer3d text
*𖣘⃝💡 ➣* ${prefix}wolfmetal text
*𖣘⃝💡 ➣* ${prefix}nature3d text
*𖣘⃝💡 ➣* ${prefix}underwater text
*𖣘⃝💡 ➣* ${prefix}golderrose text
*𖣘⃝💡 ➣* ${prefix}summernature text
*𖣘⃝💡 ➣* ${prefix}letterleaves text
*𖣘⃝💡 ➣* ${prefix}glowingneon text
*𖣘⃝💡 ➣* ${prefix}fallleaves text
*𖣘⃝💡 ➣* ${prefix}flamming text
*𖣘⃝💡 ➣* ${prefix}harrypotter text
*𖣘⃝💡 ➣* ${prefix}carvedwood text
*𖣘⃝💡 ➣* ${prefix}tiktod text1 text2
*𖣘⃝💡 ➣* ${prefix}arcade8bit text1 text2
*𖣘⃝💡 ➣* ${prefix}battlefield4 text1 text2
*𖣘⃝💡 ➣* ${prefix}pubg text1 text2

🌹 EPHOTO 360 🌹
*𖣘⃝💡 ➣* ${prefix}wetglass text
*𖣘⃝💡 ➣* ${prefix}multicolor3d text
*𖣘⃝💡 ➣* ${prefix}watercolor text
*𖣘⃝💡 ➣* ${prefix}luxurygold text
*𖣘⃝💡 ➣* ${prefix}galaxywallpaper text
*𖣘⃝💡 ➣* ${prefix}lighttext text
*𖣘⃝💡 ➣* ${prefix}beautifulflower text
*𖣘⃝💡 ➣* ${prefix}puppycute text
*𖣘⃝💡 ➣* ${prefix}royaltext text
*𖣘⃝💡 ➣* ${prefix}heartshaped text
*𖣘⃝💡 ➣* ${prefix}birthdaycake text
*𖣘⃝💡 ➣* ${prefix}galaxystyle text
*𖣘⃝💡 ➣* ${prefix}hologram3d text
*𖣘⃝💡 ➣* ${prefix}greenneon text
*𖣘⃝💡 ➣* ${prefix}glossychrome text
*𖣘⃝💡 ➣* ${prefix}greenbush text
*𖣘⃝💡 ➣* ${prefix}metallogo text
*𖣘⃝💡 ➣* ${prefix}noeltext text
*𖣘⃝💡 ➣* ${prefix}glittergold text
*𖣘⃝💡 ➣* ${prefix}textcake text
*𖣘⃝💡 ➣* ${prefix}starsnight text
*𖣘⃝💡 ➣* ${prefix}wooden3d text
*𖣘⃝💡 ➣* ${prefix}textbyname text
*𖣘⃝💡 ➣* ${prefix}writegalacy text
*𖣘⃝💡 ➣* ${prefix}galaxybat text
*𖣘⃝💡 ➣* ${prefix}snow3d text
*𖣘⃝💡 ➣* ${prefix}birthdayday text
*𖣘⃝💡 ➣* ${prefix}goldplaybutton text
*𖣘⃝💡 ➣* ${prefix}silverplaybutton text
*𖣘⃝💡 ➣* ${prefix}freefire text

🌹 NSFW MENU 🌹
*𖣘⃝💡 ➣* ${prefix}chiisaihentai
*𖣘⃝💡 ➣* ${prefix}trap
*𖣘⃝💡 ➣* ${prefix}blowjob
*𖣘⃝💡 ➣* ${prefix}yaoi
*𖣘⃝💡 ➣* ${prefix}ecchi
...
*𖣘⃝💡 ➣* ${prefix}hololewd
*𖣘⃝💡 ➣* ${prefix}sideoppai
*𖣘⃝💡 ➣* ${prefix}animefeets
*𖣘⃝💡 ➣* ${prefix}animebooty
*𖣘⃝💡 ➣* ${prefix}animethighss
*𖣘⃝💡 ➣* ${prefix}hentaiparadise
*𖣘⃝💡 ➣* ${prefix}animearmpits
*𖣘⃝💡 ➣* ${prefix}hentaifemdom
*𖣘⃝💡 ➣* ${prefix}lewdanimegirls
*𖣘⃝💡 ➣* ${prefix}biganimetiddies
*𖣘⃝💡 ➣* ${prefix}animebellybutton
*𖣘⃝💡 ➣* ${prefix}hentai4everyone
...
*𖣘⃝💡 ➣* ${prefix}wallpaper
*𖣘⃝💡 ➣* ${prefix}pussy_jpg
*𖣘⃝💡 ➣* ${prefix}kemonomimi
*𖣘⃝💡 ➣* ${prefix}nsfw_avatar
*𖣘⃝💡 ➣* ${prefix}ngif
*𖣘⃝💡 ➣* ${prefix}nsfw_neko_gif
*𖣘⃝💡 ➣* ${prefix}random_hentai_gif
...
*𖣘⃝💡 ➣* ${prefix}affect
*𖣘⃝💡 ➣* ${prefix}picture`
ikyy.sendMessage(from, { contentText: `${wibu}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu`, buttonText: { displayText: '⬅️ KEMBALI KE MENU ⬅️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'fitnah':
        ...
        case 'simi':
				...
				buff = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?apikey=${setting.lolkey}`, {method: 'get'})
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Follow https://instagram.com/atakbot_`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by ©Hentongers-Bot', imageMessage: imageMsg,
              contentText:`Follow https://instagram.com/atakbot_`,buttons,headerType:4}
...
case 'chiisaihentai':
              ...
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️ SELANJUTNYA KAK ➡️`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by ©Hentongers-Bot', imageMessage: imageMsg,
              contentText:`Follow https://instagram.com/atakbot_`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftoko})
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by ©Hentongers-Bot', imageMessage: imageMsg,
              contentText:`ᴋʟɪᴋ ꜱᴇʟᴀɴᴊᴜᴛɴʏᴀ ᴜɴᴛᴜᴋ ᴋᴇ ɢᴀᴍʙᴀʀ ʟᴀɪɴɴʏᴀ`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftoko})
              ikyy.relayWAMessage(prep)
             ...
             buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
              ...
              ikyy.relayWAMessage(prep)
                   ...
                   case 'setwelcome':
					...
					join = body.slice(11)
					ikyy.sendMessage(from ,`\`\`\`Welcome berhasil di ubah menjadi : ${body.slice(11)}\`\`\``, text,{quoted : ftoko})
				break 
	      ...
	      case 'self':
              ...
              ikyy.relayWAMessage(prep)
                ...
                case 'bucin':
                   ...
                   sendButMessage(from, titid, `ERROR JANGAN DI LANJUTKAN :V`, [
          {
            buttonId: `${prefix + command}`,
            buttonText: {
              displayText: `😡 Jangan Error 😡`,
            },
            type: 1,
          },]);
        break;
...
*𖣘⃝⃝🔖 ➣* BLOK 
*𖣘⃝⃝🔖 ➣* BLOK + BANNED
*𖣘⃝⃝🔖 ➣* BLOK + BANNED PERMANEN

🌹 KONTAK OWNER
*𖣘⃝⃝🔖 ➣* Chat : wa.me/6287721317870
`
    ikyy.sendMessage(from, { contentText: `${teksnyo}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu`, buttonText: { displayText: '⬅️ KEMBALI KE MENU ⬅️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       ...
       case 'tebakgambar':
            ...
            ikyy.sendMessage(from, buff, image, { quoted: ftoko, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+kisi_kisi+'\nWaktu : 30s' }).then(() => {
...
const serialUser = createSerial(18)
	        ...
	        addRegisteredUser(sender, serialUser)
	         const anuu = `「 *PENDAFTARAN BERHASIL* 」
*Terimakasih Telah Mendaftar Di Database Hentongers-Bot*
...
*「 Hentongsrs-Bot 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Daftar Di Database Atak Botz*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'premiumcheck':
       case 'cekpremium': 
              if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: ftoko})
       ...
       case 'buypremium':
       case 'sewabot':
            gopeynya = 'https://i.postimg.cc/Wbf4F53X/IMG-20210920-182614.jpg'
...
*Premium User*
✅ Bot Online 24 jam
✅ Unlimited Limit (1 Number)
✅ Premium User (1 Number)
Price : 
- 1 Bulan 5K
- Permanent 15K
...
No Owner : 
http://wa.me/6287721317870  
http://wa.me/6287721317870
`
  ikyy.sendMessage(from, { contentText: `${teksnya}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu`, buttonText: { displayText: '⬅️ KEMBALI KE MENU ⬅️' }, type: 1 },{ buttonId: `!payment`, buttonText: { displayText: '💳 PAYMENT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
Payment Hanya Tersedia Gopay Kak, Silahkan Tekan Tombol Di Bawah Untuk Pembayaran`
  ikyy.sendMessage(from, { contentText: `${teks}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!gopay`, buttonText: { displayText: '⋮☰ GO-PAY' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
      case 'gopay':
      gopeynya = 'https://i.postimg.cc/Wbf4F53X/IMG-20210920-182614.jpg'
      buff = await getBuffer(gopeynya)
      teks = `
Silahkan Pilih Di Bawah Kak ${pushname}`
  ikyy.sendMessage(from, { contentText: `${teks}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!minggu`, buttonText: { displayText: '⋮☰ MINGGUAN' }, type: 1 },{ buttonId: `!bulan`, buttonText: { displayText: '⋮☰ BULANAN' }, type: 1 },{ buttonId: `!manen`, buttonText: { displayText: '⋮☰ PERMANENT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
      case 'buktitf':
      gopeynya = 'https://i.postimg.cc/Wbf4F53X/IMG-20210920-182614.jpg'
      buff = await getBuffer(gopeynya)
...
Jika Sudah TF Silahkan Pc Owner : http://wa.me/6287721317870`
  ikyy.sendMessage(from, { contentText: `${teks}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu`, buttonText: { displayText: '⬅️ KEMBALI KE MENU ⬅️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
      case 'minggu':
      teks2 = `By ©Hentongers-Bot`
      teks = `
Hai Kak ${pushname} Mingguan Rp.7.000 Silahkan Scan QR & Masukkan Nominal Rp.7.000

Jika Telah Bayar Silahkan Pencet Tombol Di Bawah Untuk Kirim Screenshot Bukti TF`
               buttons = [{ buttonId: `!buktitf`, buttonText: { displayText: '⋮☰ SEND BUKTI TF' }, type: 1 } ]

               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Gopay.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Gopay.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${teks}`,
               footerText: `${teks2}`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}

               hye = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftoko, contextInfo: {mentionedJid: [sender], externalAdReply: { title: `Hi Kak ${ucapanWaktu}👋🏻\nSaya Atak Bot :-)`, body: `Jangan Bully Saya Bang`, previewType: "PHOTO", thumbnailUrl: 'https://i.postimg.cc/G3B51xF4/IMG-20210928-WA0010.jpg', sourceUrl: 'https://instagram.com/atakbot_' }}})
               ikyy.relayWAMessage(hye)
               break
      case 'bulan':
      teks2 = `By ©Hentongers-Bot`
      teks = `
Hai Kak ${pushname} Bulanan Rp.15.000 Silahkan Scan QR & Masukkan Nominal Rp.15.000 
...
Jika Telah Bayar Silahkan Pencet Tombol Di Bawah Untuk Kirim Screenshot Bukti TF`
      ...
      teks2 = `By ©Hentongers-Bot`
      teks = `
Hai Kak ${pushname} Permanent Rp.30.000 Silahkan Scan QR & Masukkan Nominal Rp.30.000
...
ikyy.sendMessage(from,{url:'./'+kyyyy},audio,{mimetype:'audio/mpeg'})
  ...
  case 'xnxxsearch':
      ...
      case 'facebok':
					...
					ikyy.sendMessage(from, buff, image, {quoted: ftoko, caption: teks})
					break
      case 'twitter':
...
*[Wait] Tunggu Sebentar..*`
				...
				ikyy.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:ftoko, caption: 'Nih Gan'})
					break  
...
buttonsMessage = {contentText: thumbInfo,footerText:'⬇️ Silahkan Pilih Jenis File Dibawah Ini ⬇️',imageMessage,buttons,headerType:4}
         ...
         case 'pinterest':
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                 ...
                 reply (mess.wait)
                    ...
                    buttons = [{buttonId: `${prefix + command} ${query}`,buttonText:{displayText: `➡️ SELANJUTNYA KAK ➡️`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by ©Hentongers-Bot', imageMessage: imageMsg,
              contentText:`ᴋʟɪᴋ ꜱᴇʟᴀɴᴊᴜᴛɴʏᴀ ᴜɴᴛᴜᴋ ᴋᴇ ɢᴀᴍʙᴀʀ ʟᴀɪɴɴʏᴀ`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftoko})
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, 'Follow IG: https://www.instagram.com/atakbot_')
...
woy = args.join(" ")
reply('wait....')
buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp?apikey=${setting.lolkey}&text=${woy}`)
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/triggered?apikey=SmartApi&img=${tolink}`)
ikyy.sendMessage(from, buffer, sticker, { quoted: ftoko })
break
       ...
       case 'triggered':
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/triggered.webp -o ./sticker/triggered.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    ikyy.sendMessage(from, fs.readFileSync(`./sticker/triggered.webp`), sticker, {quoted: ftoko})
           ...
           teks = args.join(' ')
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/ttg.webp -o ./sticker/ttg.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    ikyy.sendSticker(from, fs.readFileSync(`./sticker/ttg.webp`), sticker, {quoted: ftoko})
                    limitAdd(sender, limit)
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Hayo mau ngapain kwokwok ;v mau sc bot ini nih ➡️ : https://github.com/Hentongers/`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             becenya = 'https://i.postimg.cc/0yfL8Frk/IMG-20210918-172022.jpg'
             buff = await getBuffer(becenya)
             ...
             for (let _ of anu) {
             	tes = `${body.slice(4)}`
             	ikyy.sendMessage(_.jid, bc, { contentText: `${tes}`, footerText: `Mang Bc By Ridho`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: image, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             	textt = `${body.slice(4)}`
             ikyy.sendMessage(_.jid, { contentText: `${textt}`, footerText: `*_Broadcast Message By RidhoGanz_*`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://i.postimg.cc/Wbf4F53X/IMG-20210920-182614.jpg'
               buff = await getBuffer(urlinfo)
               mark = '6287721317870@s.whatsapp.net'
               thankslort = `🌹 *INFORMATION* 
*𖣘⃝🐺 ➣* *Creator :* _*Hentongers*_
*𖣘⃝🐺 ➣* *Prefix :* _*[ ${prefix} ]*_
*𖣘⃝🐺 ➣* *Speed :* *${latensie.toFixed(4)} _Second_*
*------------------------------------*
*𖣘⃝🐺 ➣* *Github :* 
_*github.com/Hentongsers*_

*𖣘⃝🐺 ➣* *Instagram :* 
_*instagram.com/Hentosers*__

*𖣘⃝🐺 ➣* *Whatsapp :* 
_*wa.me/6285885775526*_
...
${botName}`
             ikyy.sendMessage(from, { contentText: `${thankslort}`, footerText: 'By 🤖 Hentongers Bot 🤖', buttons: [{ buttonId: `!menu`, buttonText: { displayText: '⬅️ KEMBALI KE MENU ⬅️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender,mark]}}}, 'buttonsMessage')
              break;
case 'media':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             ikyy.sendMessage(from, `Jangan Lupa Follow IG Owner Ya Kak\n\n*Link IG :*\nhttps://www.instagram.com/atakbot_/`, text, {contextInfo: {"externalAdReply": { "title": `Ga Follow Ga Kawan`, "thumbnail": fs.readFileSync('./media/Menu.jpg'), "sourceUrl": 'http://follow bro' }} })
             break
      case 'atakgroup':
             ikyy.sendMessage(from, `Group 𝘼𝙩𝙖𝙠 𝘽𝙤𝙩𝙯 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 1\n\n*Link Group :* https://chat.whatsapp.com/FB1qKVJ3cvP2DUmoMGV5it\n\nGroup X -Dark Team\n\n*Link Group :*\nhttps://chat.whatsapp.com/FB1qKVJ3cvP2DUmoMGV5it`, text, {contextInfo: {"externalAdReply": { "title": `Ga Join Ga Kawan`, "thumbnail": fs.readFileSync('./media/Menu.jpg'), "sourceUrl": 'http://join bro' }} })
             break
      case 'q':
    if (!m.quoted) return reply('reply pesan!')
    let rii = ikyy.serializeM(await m.getQuotedObj())
    ...
    break
      ...
      case 'linkgroup':
             ...
             ikyy.sendMessage(from, `https://chat.whatsapp.com/${linkgc}\n\nlink Group *${groupName}*`, text, {contextInfo: {"externalAdReply": { "title": `Nih Kak Link Group ${groupName}`, "thumbnail": await getBuffer(await ikyy.getProfilePicture(from)), "sourceUrl": 'https://chat.whatsapp.com/${linkgc}' }} })
             break
...
if (budy.includes("Numa")){
        ...
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: ftoko, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/5537.webp');
